...
public class MovieController {
    ...
    public ResponseWrapper<MovieDto> getMovieById(@PathVariable("id") @Min(0) Integer id) {
    ...
    public ResponseWrapper<MovieDto> updateMovie(@PathVariable("id") @Min(0) Integer id,
    ...
    public void deleteMovie(@PathVariable("id") @Min(0) Integer id) {
